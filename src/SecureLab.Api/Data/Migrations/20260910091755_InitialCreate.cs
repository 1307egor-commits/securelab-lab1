        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_incidents_users_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByDisplayName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ChangedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_incident_status_changes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_incident_status_changes_incidents_IncidentId",
                        column: x => x.IncidentId,
                        principalTable: "incidents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_incident_status_changes_IncidentId",
                table: "incident_status_changes",
                column: "IncidentId");

            migrationBuilder.CreateIndex(
                name: "IX_incidents_OwnerUserId",
                table: "incidents",
                column: "OwnerUserId");
        }
